return {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        ltex = {
          languageToolOrg = {
            username = vim.g.languageToolEmail or '<EMAIL>',
            apiKey = vim.g.languageToolToken or '<token>',
          },
  ...
  { -- code action preview
    ...
    config = function()
      ...
      vim.keymap.set({ "v", "n" }, "ca", require("actions-preview").code_actions, { desc = "[C]ode [A]ctions" })
    end,
  },
  {
